...
**This repository can be used to reinforce knowledge and skills in data science, and you can also add examples of use cases in data science with new algorithms, approaches, or tools. This is my change Professor Millan**